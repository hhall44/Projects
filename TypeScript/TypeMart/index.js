...
console.log(`Purcahse details: ${productName}, Shipping Address: ${shippingAddress}, Product Price: ${Number(product.price)}, Tax: ${taxTotal}, Shipping: ${shipping}, Total: ${total}.`);
